...
const { data, loading, error } = useFetch(""); //here we must write a path!;
    ...
    <div className="featured">
      {loading ? (
        ...
        <>
          ...
          <div className="featuredItem">
            <img
              src="https://cf.bstatic.com/xdata/images/city/square250/653109.jpg?k=39834303d6af8adc39cc8218ea8efc5291a013bd3228d53a50cb836833f4777f&o="
              alt=""
              className="featuredImg"
            />
            <div className="featuredTitles">
